            ...
            <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Địa chỉ tạm chú ..." name="PermanentAddress">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Số điện thoại cơ quan ..." name="WorkPhoneNumber">
                  </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row" align="center">
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <a href="/employee/add_working_process" class="btn btn-success">Tiếp</a>
                  </div>
                </div>
            </div>
        </form>

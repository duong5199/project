...
<div class="container-fluid">
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Cập nhật thông tin kỷ luật</h3>
        </div>
        @if($errors->any())
        ...
        <form role="form" method="POST" action="" style="margin: 20px">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>Mã KL</label>
                        <input type="text" class="form-control" value="{{$temp->praise_discipline_code}}" name="DisciplineCode">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <label>Lý do</label>
                        <input type="text" class="form-control" value="{{$temp->praise_discipline_reason}}" name="DisciplineReason">
                    </div>
                </div>
            </div>
            <div class="row">
